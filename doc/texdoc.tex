...
see Section~\ref{sec:prec}.)

To set your favorite mode, just insert a line |mode = «mode»| in this file,
where |«mode»| is one of |view|, |mixed|, |list| or |showall|. To set your
preferred language, use |lang = «2-letter code»|, but it is usually detected
automatically.
...
you may be curious or have special needs. The final part is a full reference
including a few points omitted in the present and next parts.
